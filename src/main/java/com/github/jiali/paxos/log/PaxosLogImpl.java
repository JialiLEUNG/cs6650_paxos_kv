package com.github.jiali.paxos.log;
...
import com.github.jiali.paxos.utils.MmapTool;

public class PaxosLogImpl implements PaxosLog {
	...
	public PaxosLogImpl(Accepter accepter) throws IOException {
		// TODO Auto-generated constructor stub
		this.accepter = accepter;
		this.tool = new MmapTool(getLogFileAddr());
	}
	
	public PaxosLogImpl(String addr) throws IOException {
		// TODO Auto-generated constructor stub
	...
	public String getLogFileAddr() {
		...
		return this.accepter.getNodeConfiguration().getDataDir() + "accepter-" +
	...
	public static void main(String[] args) {
		try {
			// dataDir is where the data log is written to (data persistence)
			PaxosLog paxosLog = new PaxosLogImpl("./dataDir/test.log");
			paxosLog.setInstanceValue(1, "hello");
			paxosLog.setInstanceValue(2, "paxos");
			paxosLog.setInstanceBallot(3, 1);
			paxosLog.setInstanceAcceptedBallot(4, 2);
			paxosLog.recoverFromLog();
			paxosLog.clearLog();
			paxosLog.setInstanceValue(1, "hello");
			paxosLog.setInstanceValue(2, "paxos");
			paxosLog.recoverFromLog();
